...
def max_district_2(A, d, i=0, j=None, memo={}):
    ...
    for k in range(i, j):
        ...
        if (i, k, 1) not in memo:
            memo[(i, k, 1)] = max_district_2(A, 1, i, k)

        if (k + 1, j, d - 1) not in memo:
            memo[(k + 1, j, d - 1)] = max_district_2(A, d - 1, k + 1, j)
...
def max_district_3(A, d, i=0, j=None, memo={}):
    ...
    for k in range(i, j):
        ...
        if (i, k, 1) not in memo:
            memo[(i, k, 1)] = max_district_3(A, 1, i, k)

        if (k + 1, j, d - 1) not in memo:
            memo[(k + 1, j, d - 1)] = max_district_3(A, d - 1, k + 1, j)
...
for i in range(len(A)):
    ...
    print(max_district_2(A[i:] + A[:i], d))
